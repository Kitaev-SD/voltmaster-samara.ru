...
<?else:?>
	...
	<?ob_start();?>
		<div class="ask_a_question">
			...
			<div class="outer">
				<span><a href="/info/faq/" class="btn btn-default btn-lg white animate-load"<span><?=(strlen($arParams['S_ASK_QUESTION']) ? $arParams['S_ASK_QUESTION'] : GetMessage('S_ASK_QUESTION'))?></span></a></span>
			</div>
		</div>
