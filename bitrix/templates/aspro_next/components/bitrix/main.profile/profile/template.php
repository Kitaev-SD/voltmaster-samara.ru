...
<script>
	...
	<div class="form-block-wr">
		<form method="post" name="form1" class="main" action="<?=$arResult["FORM_TARGET"]?>?" enctype="multipart/form-data">
			...
			<?if($arResult["arUser"]["UF_CHECKORG"] === "0"):?>
			<div class="form-control">
				<div class="wrap_md">
					<div class="iblock label_block">
						<label>Наименование организации<span class="star">*</span></label>
						<input required type="text" name="UF_ORGNAME" maxlength="250" value="<? echo $arResult["arUser"]["UF_ORGNAME"]?>" />
					</div>
					<div class="iblock text_block">
			...
			<div class="form-control">
				<div class="wrap_md">
					<div class="iblock label_block">
						<label>ИНН<span class="star">*</span></label>
						<input required type="text" name="UF_INN" maxlength="50" value="<? echo $arResult["arUser"]["UF_INN"]?>" />
					</div>
					<div class="iblock text_block">
			...
			<div class="form-control">
				<div class="wrap_md">
					<div class="iblock label_block">
						...
						<input type="text" name="UF_ACCOUNT" maxlength="250" value="<? echo $arResult["arUser"]["UF_ACCOUNT"]?>" />
					</div>
					<div class="iblock text_block">
			...
			<div class="form-control">
				<div class="wrap_md">
					<div class="iblock label_block">
						<label>БИК</label>
						<input type="text" name="UF_BIK" maxlength="50" value="<? echo $arResult["arUser"]["UF_BIK"]?>" />
					</div>
					<div class="iblock text_block">
			...
			<div class="form-control">
				<div class="wrap_md">
					<div class="iblock label_block">
						...
						<input type="text" name="UF_LEGALADDRESS" maxlength="250" value="<? echo $arResult["arUser"]["UF_LEGALADDRESS"]?>" />
					</div>
					<div class="iblock text_block">
			...
			<div class="form-control">
				<div class="wrap_md">
					<div class="iblock label_block">
						<label>Банк</label>
						<input type="text" name="UF_BANK" maxlength="250" value="<? echo $arResult["arUser"]["UF_BANK"]?>" />
					</div>
					<div class="iblock text_block">
			...
			<div class="form-control">
				<div class="wrap_md">
					<div class="iblock label_block">
						...
						<input type="text" name="UF_CORRACC" maxlength="250" value="<? echo $arResult["arUser"]["UF_CORRACC"]?>" />
					</div>
					<div class="iblock text_block">
            ...
            <?//if( !empty($arResult['UF_DISCOUNTCARD']) ){?>
                <div class="form-control">
                    <div class="wrap_md">
                        <div class="iblock label_block">

                            <label><?=GetMessage("PERSONAL_DISCOUNTCARD")?></label>
                            <input type="text" maxlength="50" name="UF_DISCOUNTCARD"
                                   placeholder="<?=$arResult['UF_DISCOUNTCARD']?>" value="<?=$arResult['UF_DISCOUNTCARD']?>" />
...
<!--		--><?//вывод блока соц.сетей if($arResult["SOCSERV_ENABLED"]){ $APPLICATION->IncludeComponent("bitrix:socserv.auth.split", "main", array("SUFFIX"=>"form", "SHOW_PROFILES" => "Y","ALLOW_DELETE" => "Y"),false);}?>
	</div>
</div>