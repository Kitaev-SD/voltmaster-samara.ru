...
//var_dump($arResult["ORDER"]["STATUS_ID"]);
...
$APPLICATION->AddHeadString('<link href="/bitrix/templates/aspro_next/components/bitrix/sale.order.ajax/main/style.min.css" type="text/css" rel="stylesheet" />',true);
		...
		<div id="bx-soa-order" class="row bx-<?=$arParams['TEMPLATE_THEME']?>" style="opacity: 0">
			...
			<div class="col-sm-9 bx-soa">
				...
				<div id="bx-soa-properties" data-visited="false" class="bx-soa-section bx-active">
					<div class="bx-soa-section-title-container">
						<h2 class="bx-soa-section-title col-sm-9 11">
							<span class="bx-soa-section-title-count"></span><?=$arParams['MESS_BUYER_BLOCK_NAME']?>
						</h2>

						<div class="col-xs-12 col-sm-3 text-right"><!--a href="" class="bx-soa-editstep"><?=$arParams['MESS_EDIT']?></a--></div>
                        <div class="col-sm-12 col-xs-12 bx-soa-section-content--info">
                            для автоматического заполнения полей формы заполните свой профиль
                        </div>
					</div>
