...
Class up_boxberrydelivery extends CModule {
    ...
    public function InstallDelivery()
    {
        ...
        $fields = [
            ...
            'PARENT_ID'   => 0,
            'SORT'        => 100,
            'NAME'        => GetMessage('BOXBERRY_DELIVERY_SHIPPING_NAME'),
            'DESCRIPTION' => GetMessage('BOXBERRY_DELIVERY_SHIPPING_DESCRIPTION'),
            'CURRENCY'    => CCurrency::GetBaseCurrency(),
            'CONFIG'      => [
                'MAIN' => [
                    'SID'               => 'boxberry',
                    'DESCRIPTION_INNER' => GetMessage('BOXBERRY_DELIVERY_SHIPPING_NAME'),
                    'MARGIN_VALUE'      => 0,
                    'MARGIN_TYPE'       => '%',
                    'CURRENCY'          => CCurrency::GetBaseCurrency(),
                ]
            ...
            ], CFile::MakeFileArray(__DIR__ .'/img/boxberry_logo.png')
            ),
        ];
