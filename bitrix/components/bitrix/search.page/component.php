...
if($q!==false)
{
	...
	if($arParams["USE_LANGUAGE_GUESS"] == "N" || isset($_REQUEST["spell"]) || $arParams["USE_LANGUAGE_GUESS"] === null)
	{
...
if(
	...
	$arResult["REQUEST"]["QUERY"] = $arResult["REQUEST"]["~QUERY"] = str_ireplace("n'y", 'тэн', $q_lower);
}
...
if(
	...
	$arResult["REQUEST"]["QUERY"] = $arResult["REQUEST"]["~QUERY"] = str_ireplace("ьлз", 'mkp', $q_lower);
}
...
if(
	...
	$arResult["REQUEST"]["QUERY"] = $arResult["REQUEST"]["~QUERY"] = str_ireplace("евф7560", 'tda756', $q_lower);
}
