...
<tr>
 ...
 <br>
			 ...
			 Заказ принят, ожидается проверка менеджером <br>
		...
		<p style="margin-top: 0; margin-bottom: 20px; line-height: 20px;">
			<span style="background-color: #d1d1d1;">Для получения подробной информации по заказу пройдите на сайт&nbsp;</span><a href="https:/#SERVER_NAME#/personal/orders/#ORDER_ID#" style="background-color: #d1d1d1;">https://#SERVER_NAME#/personal/orders/#ORDER_ID#</a><br>
		</p>
		<p style="margin-top: 0; margin-bottom: 20px; line-height: 20px;">
 <br>
 ...
 <br>
			 Пожалуйста, при обращении к администрации сайта Вольтмастер-Самара ОБЯЗАТЕЛЬНО указывайте номер Вашего заказа - #ORDER_ID#.<br>
 <br>
