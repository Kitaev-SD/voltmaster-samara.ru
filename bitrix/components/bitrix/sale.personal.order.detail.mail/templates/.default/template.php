	...
	<?else:?>	
		...
		<table class="bx_order_list_table" cellpadding="0" cellspacing="0" width="100%" style="max-width:850px; background-color: #d1d1d1; border-radius: 2px; border:1px solid #d1d1d1; margin: 0 auto;" border="1" bordercolor="#d1d1d1">
			...
			<thead>
				<tr>
					<td colspan="2" height="83" width="100%" bgcolor="#eaf3f5" style="max-width:850px; border: none; padding-top: 10px; padding-right: 17px; padding-bottom: 10px; padding-left: 17px;">
						...
						<tbody>
						<tr>
							<td bgcolor="#ffffff" height="75" style="max-width:850px; font-weight: bold; text-align: center; font-size: 26px; color: #0b3961;">
				...
				<tr>
					<td colspan="2" width="100%" bgcolor="#f7f7f7" valign="top" style="max-width:850px; border: none; padding-top: 0; padding-right: 44px; padding-bottom: 10px; padding-left: 44px;">
						<p style="max-width:850px; margin-top:15px; margin-bottom: 10px; font-weight: bold; font-size: 19px;">
			...
			<?if($arParams["SHOW_ORDER_BASE"]=='Y'):?>
				<tr width="100%" bgcolor="#f7f7f7" valign="top" style="max-width:850px; border: none; padding-top: 0; padding-right: 44px; padding-bottom: 10px; padding-left: 44px;">
					<td bgcolor="#ddd">
				...
				<?endif*/?>
				<tr height="23" width="100%" bgcolor="#f7f7f7" style="max-width:850px; border: none; padding-top: 10px; padding-right: 17px; padding-bottom: 10px; padding-left: 17px;"><td colspan="2" style="max-width:850px; border:none"></td></tr>
			<?endif?>
			...
			<?if($arParams["SHOW_ORDER_USER"]=='Y'):?>
				<?if(intval($arResult["USER_ID"])):?>
					...
					<?if(strlen($arResult["USER_NAME"])):?>
						<tr height="83" width="100%" bgcolor="#f7f7f7" style="max-width:850px; border: none; padding-top: 10px; padding-right: 17px; padding-bottom: 10px; padding-left: 17px;">
			...
			<tr width="100%" bgcolor="#f7f7f7" style="max-width:850px; border: none; padding-top: 10px; padding-right: 17px; padding-bottom: 10px; padding-left: 17px;">
				<td colspan="2">
		...
		<tr>
		<td colspan="2" width="100%" bgcolor="#f7f7f7" style="max-width:850px; border: none; padding-top: 10px; padding-right: 17px; padding-bottom: 10px; padding-left: 17px;">
			...
			<p style="max-width:850px; line-height:20px;margin-top:0">
				...
				<br>
				<span style="max-width:850px; background-color: #d1d1d1;">Для получения подробной информации по заказу пройдите на сайт&nbsp;</span><a href="https://<?=$_SERVER['HTTP_HOST']?><?=$arParams['PATH_TO_LIST']?><?=$arResult['ACCOUNT_NUMBER']?>" style="max-width:850px; background-color: #d1d1d1;">https://<?=$_SERVER['HTTP_HOST']?><?=$arParams['PATH_TO_LIST']?><?=$arResult['ACCOUNT_NUMBER']?></a>

				<br>
				 Обратите внимание, что для входа в этот раздел Вам необходимо будет ввести логин и пароль пользователя сайта Вольтмастер-Самара.
				<br>
				 Для того, чтобы аннулировать заказ, воспользуйтесь функцией отмены заказа, которая доступна в Вашем персональном разделе сайта Вольтмастер-Самара.
				<br>
				 Пожалуйста, при обращении к администрации сайта Вольтмастер-Самара ОБЯЗАТЕЛЬНО указывайте номер Вашего заказа - <?=$arResult["ACCOUNT_NUMBER"]?>.
				<br>
				 Спасибо за покупку!
			</p>
		</td>
...
<?$email_template = $arResult;
	...
	file_put_contents('/var/www/www-root/data/www/voltmaster-samara.ru.capyba.ru/test_email_template.php', $arResult);
